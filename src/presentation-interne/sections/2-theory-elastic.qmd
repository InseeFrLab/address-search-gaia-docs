...
Méthode de tri robuste afin de retourner le meilleur écho :  
  ...
  1. Tri décroissant en fonction du [**score ES**]{.green2}
  2. À score ES égal, privilégier la [**voie la plus courte textuellement**]{.blue2}
  3. À longueur égale, privilégier la voie avec l'[**idGaiaVoie**]{.green2} le plus élevé
