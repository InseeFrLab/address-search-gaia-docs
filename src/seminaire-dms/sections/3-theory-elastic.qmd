...
- Moteur ⚙️ utilisable en n'importe quel langage (requêtes HTTP).  
...
n = niveau  
sc = sous-chaîne *(un mot, un 3-grams...)*  
...
- Match 🎯 mot sur nom de voie avec fuzzi 1 → boost 20.  
- Match 🎯 mot sur type de voie ou nom de voie → boost 15.  
