...
- [**Pour chaque nom de voie du référentiel**]{.blue2}, compter le nombre de mots qui matchent 🎯 avec les mots de l'adresse recherchée.  
...
[**Contourner les fautes d'orthographes**]{.blue2} : chaque mot est découpé en sous-chaînes de n caractères consécutifs.  
...
- Tests effectués pour choisir ces valeurs, en fonction de [**la précision et la rapidité**]{.blue2} des requêtes.  
...
Il est possible de comparer deux textes, deux ngrams ou n'importe quel autre groupe de caractères.  
...
- Match 🎯 nom de voie entier sans découpage avec fuzzi 1 → **boost 200**. *Ex : "3 rue du genral de gaulle" avec "du gen**e**ral de gaulle"*.  
- Match 🎯 chaque mot du nom de voie avec fuzzi 1 → **boost 15**. *Ex : "3 rue du genral de gaule" avec "du", "gen**e**ral", "de", "gaul**l**e"*.  
- Match 🎯 chaque mot du type de voie avec fuzzi 1 → **boost 5**. *Ex : "3 rue du general de gaule" avec "rue"*.  
