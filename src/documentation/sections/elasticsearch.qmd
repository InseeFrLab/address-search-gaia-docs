...
![Schéma algorithme d'identification d'adresse avec ElasticSearch](documentation/img/schema_moteur_fr.png){fig-align="center" width=75%}
...
- voie sûre : l’adresse contient plus de 90 % des trigrammes de la voie du référentiel*  
