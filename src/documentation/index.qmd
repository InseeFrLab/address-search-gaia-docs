...
Pour lancer une identification avec le moteur ElasticSearch développé en python, il faut aller sur le dépôt git et lire le READ.ME. Il est possible d'accéder au dépôt en cliquant sur le logo git sur la banière rouge en haut du site. Puis aller sur LS3 pour cloner le projet.
